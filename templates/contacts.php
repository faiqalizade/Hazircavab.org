...
<div class="main_page_header_after">
    <div id='add_question_form_wrapper'>
        <form id='add_question_form' method="post">
            ...
            <p id='question_tags_error'></p>
            <p class='add_question_input_titles'>Сообшения:</p>
        ...
        <div id='add_question_send_buttons_wrapper'>
            <label for='feedback_subm' style="cursor: pointer; color: rgb(101, 193, 120);" class='add_question_send_button' id='add_question_send_button'>Опубликовать</label>
        </div>
    </div>
</div>